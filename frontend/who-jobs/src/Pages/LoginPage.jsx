        ...
        <div className="w-full max-w-sm">
          ...
          <div className="rounded-2xl border border-brand-border bg-brand-card p-8 sm:p-9 shadow-[0_30px_70px_-25px_rgba(30,41,59,0.25)]">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="flex justify-end">
                <a
                  ...
                  className="font-mono text-xs text-brand-muted hover:text-sky-400 transition-colors"
                >
            ...
            <p className="mt-7 text-center text-sm text-brand-muted">
              ...
              <Link
                href="/register"
                className="font-semibold text-brand-title hover:text-sky-400 transition-colors"
              >
                Creá una
              </Link>
            </p>
